...
// Full-page WebGL backdrop (procedural geometry only, no binary assets).
// Client-only: WebGL + window/pointer listeners cannot run during SSR.
...
// Colored section blobs removed: the 3D backdrop is the only page background.
const SectionBackdrop: React.FC = () => null;
...
export default function Home() {
  return (
    <>
      ...
      {/* Persistent 3D backdrop behind the entire page */}
      <Scene3D />

      {/* Landing page is dark-only. `dark` scopes the dark theme to this page
          without touching <html>, so other routes keep the user's preference. */}
      <div className="dark relative z-10 font-sans overflow-x-hidden bg-transparent text-foreground">
        ...
        <style jsx global>{`
          ...
          /* Sections are transparent: the fixed 3D backdrop is the page
             background. No per-section color washes, no shifting gradients. */
          .section-animated {
            position: relative;
            overflow: hidden;
          }
          ...
          /* Keep section headings crisp where they float over the busy
             center of the 3D backdrop. Halo matches the active theme base. */
          .section-animated h2,
          .section-animated h3 {
            text-shadow:
              0 1px 2px rgba(245, 243, 236, 0.55),
              0 2px 26px rgba(245, 243, 236, 0.75);
          }
          .section-animated p {
            text-shadow: 0 1px 18px rgba(245, 243, 236, 0.7);
          }
          .dark .section-animated h2,
          .dark .section-animated h3 {
            text-shadow:
              0 1px 2px rgba(3, 5, 12, 0.7),
              0 2px 28px rgba(3, 5, 12, 0.85);
          }
          .dark .section-animated p {
            text-shadow: 0 1px 20px rgba(3, 5, 12, 0.85);
          }
        `}</style>
        ...
        <section className="relative min-h-screen w-full overflow-hidden bg-transparent text-white">
          ...
          />
          {/* Translucent overlays keep white text legible while letting the
              3D backdrop glow through the hero. */}
          <div className="absolute inset-0 bg-gradient-to-b from-slate-950/75 via-slate-950/45 to-slate-950/70" />
        ...
        {/* Footer Section */}
        <footer className="bg-background/70 backdrop-blur text-muted-foreground py-8 px-4 text-center shadow-lg">
